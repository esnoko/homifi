...
export const FeaturedCards = ({onPress}: Props) => {
  return (
    <TouchableOpacity onPress={onPress} className='flex flex-col items-start w-60 h-80 relative'>
        ...
        <Image source={images.cardGradient} className='rounded-2xl size-full absolute bottom-0'/>
        ...
        <View className='flex flex-col items-start absolute bottom-5 inset-x-5'>
            ...
            <Text className='text-base font-rubik text-white'>Polokwane LP</Text>

            <View className='flex flex-row items-center justify-between w-full'>
                <Text className='text-white font-rubik-extrabold text-xl'>R2, 000</Text>
    ...
    return (
      <TouchableOpacity onPress={onPress} className='flex-1 w-full px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative'>
        ...
        <View className='flex flex-col mt-2'>
            ...
            <Text className='text-xs font-rubik text-black-200'>Polokwane LP</Text>

            <View className='flex flex-row items-center justify-between mt-2'>
                <Text className='text-base font-rubik-bold text-primary-300'>R2, 000</Text>
